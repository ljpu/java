...
- **1:** [FOLLOW](https://links.lpu.com/lin) Ranga on LinkedIn

## Check Out Our Amazing ROADMAPS

- **1:** [AWS Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#aws-roadmap)
- **2:** [Azure Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#azure-roadmap)
- **3:** [Google Cloud Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#google-cloud-roadmap)
- **4:** [Cloud Beginner Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#cloud-beginner-roadmap)
- **5:** [DevOps Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#devops-roadmap)
- **6:** [Java Full Stack Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#java-full-stack-roadmap)
- **7:** [Java Microservices Roadmap](https://github.com/lpu/roadmaps/blob/main/README.md#java-microservices-roadmap)
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.lpu.springboot</groupId>
...
### /src/main/java/com/lpu/springboot/controller/StudentController.java

```java
package com.lpu.springboot.controller;
...
import com.lpu.springboot.model.Course;
import com.lpu.springboot.service.StudentService;
...
### /src/main/java/com/lpu/springboot/model/Course.java

```java
package com.lpu.springboot.model;
...
### /src/main/java/com/lpu/springboot/model/Student.java
...
### /src/main/java/com/lpu/springboot/service/StudentService.java

```java
package com.lpu.springboot.service;
...
import com.lpu.springboot.model.Course;
import com.lpu.springboot.model.Student;
...
### /src/main/java/com/lpu/springboot/StudentServicesApplication.java

```java
package com.lpu.springboot;
...
### /src/test/java/com/lpu/springboot/controller/StudentControllerTest.java
...
### /src/test/java/com/lpu/springboot/StudentServicesApplicationTests.java
